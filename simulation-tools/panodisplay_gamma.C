...
TH2D* telEvent(int telNumber, int eventNumber){
    ...
    */
    ...
    for(int i=1; i<=16; i++){
        for(int j=1; j<=16; j++){
            if(image->GetBinContent(i,j)>9.0) npixtrigq1++;
        }
    }
    for(int i=17; i<=32; i++){
        for(int j=1; j<=16; j++){
            if(image->GetBinContent(i,j)>9.0) npixtrigq2++;
        }
    }
    for(int i=1; i<=16; i++){
        for(int j=17; j<=32; j++){
            if(image->GetBinContent(i,j)>9.0) npixtrigq3++;
        }
    }
    for(int i=17; i<=32; i++){
        for(int j=17; j<=32; j++){
            if(image->GetBinContent(i,j)>9.0) npixtrigq4++;
        }
    }
